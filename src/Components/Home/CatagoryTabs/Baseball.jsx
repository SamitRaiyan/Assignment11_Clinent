...
const Baseball = (props) => {
  const navigate=useNavigate()
    ...
    const { toy_name, price, image, rating,_id} = props.Baseball;
    ...
    return (<div data-aos="zoom-in">
      ...
      <div className="card w-80 bg-base-100 shadow-2xl">
        ...
        <div className="card-body ">
          ...
          <label  onClick={handleNavigate} className="btn px-5 py-2 rounded-lg bg-yellow-600 text-white">view details</label>
          </div>
        </div>
      </div>
    </div>
