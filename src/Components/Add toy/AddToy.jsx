...
console.log(user)
    ...
    const handleAddtoy = event => {
        ...
        const rating = form.rating[0].value;
        const description = form.description.value;
        const image = form.image.value;

        const user = { addedBy, email,toy_name,description ,quantity,rating,price,materials,category,image};
        console.log(user);
        ...
        fetch('https://toy-shop-server-gamma.vercel.app/alltoys', {
          ...
          fetch('https://toy-shop-server-gamma.vercel.app/mytoys', {
          method: 'POST',
          headers: {
            'content-type': 'application/json'
          },
